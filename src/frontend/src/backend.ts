...
export class Backend implements backendInterface {
    ...
    async addBlogPost(arg0: string, arg1: string, arg2: Array<string>, arg3: string): Promise<void> {
    ...
    async getCoverLetter(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getCoverLetter();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEducation(): Promise<Array<Education>> {
        if (this.processError) {
            try {
    ...
    async getResumeTitle(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getResumeTitle();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initialize(arg0: string, arg1: Array<string>, arg2: Array<Education>, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initialize(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setCoverLetter(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setCoverLetter(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setEducation(arg0: Array<Education>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setEducation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setResumeTitle(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setResumeTitle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBlogPost(arg0: string, arg1: string, arg2: Array<string>, arg3: string): Promise<void> {
        if (this.processError) {
            try {
